...
class kicad_cli:
    ...
    class pcb:
        ...
        cmd: "drc | export | _import | render | upgrade"
        # Arguments (Required)
        # Arguments (Optional)
        # Flags
        help: bool = False
        ...
        class drc:
            ...
            Args:
                ...
                save_board: Save the board after DRC, must be used with --refill-zones
            """
        ...
        class export:
            ...
            cmd: "_3dpdf | brep | drill | dxf | gencad | gerbers | glb | hpgl | ipc2581 | ipcd356 | odb | pdf | ply | pos | ps | stats | step | stl | stpz | svg | u3d | vrml | xao"
            # Arguments (Required)
            # Arguments (Optional)
            # Flags
            help: bool = False
            ...
            class _3dpdf:
                ...
                Args:
                    ...
                    no_extra_pad_thickness: Disable extra pad thickness (pads will have normal thickness)
                """
                ...
                """The variant name(s) to output, can be used multiple times to specify multiple variants."""
                ...
                """Disable extra pad thickness (pads will have normal thickness)"""
            ...
            class drill:
                ...
                Args:
                    ...
                    report_path: Report output file path [nargs=0..1] [default: ""]
                ...
                """Report output file path [nargs=0..1] [default: ""]"""
                ...
                """Generate report of drill hits"""
                generate_tenting: bool = False
                """Generate a file specifically for tenting"""
            ...
            class dxf:
                ...
                Args:
                    ...
                    check_zones: Check and refill zones if required
                """
                ...
                scale: str | None = None
                """Scale for the PCB, not for the border and title. Use 0 for autoscale [nargs=0..1] [default: 1]"""
                variant: str | None = None
                """The variant name(s) to output, can be used multiple times to specify multiple variants."""
                # Flags
                help: bool = False
                ...
                """Check and refill zones if required"""
            ...
            class ipc2581:
                ...
                Args:
                    ...
                    bom_rev: BOM revision to use in the output file. Defaults to schematic revision from the project file [nargs=0..1] [default: ""]
                    variant: The variant name(s) to output, can be used multiple times to specify multiple variants.
                    help: Shows help message and exits
                ...
                bom_rev: str | None = None
                """BOM revision to use in the output file. Defaults to schematic revision from the project file [nargs=0..1] [default: ""]"""
                variant: str | None = None
                """The variant name(s) to output, can be used multiple times to specify multiple variants."""
                # Flags
                help: bool = False
            ...
            class pdf:
                ...
                Args:
                    ...
                    drill_shape_opt: Set pad/via drill shape option (0 = no shape, 1 = small shape, 2 = actual shape) [nargs=0..1] [default: 2]
                    scale: Scale for the PCB, not for the border and title. Use 0 for autoscale [nargs=0..1] [default: 1]
                    bg_color: Background color, can be in hex #rrggbb, #rrggbbaa; or css rgb(r,g,b), rgba(r,g,b,a) format [nargs=0..1] [default: ""]
                    variant: The variant name(s) to output, can be used multiple times to specify multiple variants.
                    help: Shows help message and exits
                ...
                """Background color, can be in hex #rrggbb, #rrggbbaa; or css rgb(r,g,b), rgba(r,g,b,a) format [nargs=0..1] [default: ""]"""
                variant: str | None = None
                """The variant name(s) to output, can be used multiple times to specify multiple variants."""
                # Flags
                help: bool = False
            ...
            class ps:
                ...
                Args:
                    ...
                    theme: Color theme to use (will default to PCB Editor settings) [nargs=0..1] [default: ""]
                    drill_shape_opt: Set pad/via drill shape option (0 = no shape, 1 = small shape, 2 = actual shape) [nargs=0..1] [default: 2]
                    track_width_correction: Track width correction [mm]. Used to compensate errors in track widths, pad and via sizes. [nargs=0..1] [default: 0]
                    x_scale_factor: X scale adjust for exact scale. [nargs=0..1] [default: 1]
                    y_scale_factor: Y scale adjust for exact scale. [nargs=0..1] [default: 1]
                    scale: Scale for the PCB, not for the border and title. Use 0 for autoscale [nargs=0..1] [default: 1]
                    variant: The variant name(s) to output, can be used multiple times to specify multiple variants.
                    help: Shows help message and exits
                    mirror: Mirror the board (useful for trying to show bottom layers)
                ...
                drill_shape_opt: str | None = None
                """Set pad/via drill shape option (0 = no shape, 1 = small shape, 2 = actual shape) [nargs=0..1] [default: 2]"""
                track_width_correction: str | None = None
                """Track width correction [mm]. Used to compensate errors in track widths, pad and via sizes. [nargs=0..1] [default: 0]"""
                x_scale_factor: str | None = None
                """X scale adjust for exact scale. [nargs=0..1] [default: 1]"""
                y_scale_factor: str | None = None
                """Y scale adjust for exact scale. [nargs=0..1] [default: 1]"""
                scale: str | None = None
                """Scale for the PCB, not for the border and title. Use 0 for autoscale [nargs=0..1] [default: 1]"""
                variant: str | None = None
                """The variant name(s) to output, can be used multiple times to specify multiple variants."""
            ...
            class stats:
                ...
                Args:
                    ...
                    help: Shows help message and exits
                    exclude_footprints_without_pads: Exclude footprints without pads
                    subtract_holes_from_board: Subtract holes from the board area
                    subtract_holes_from_copper: Subtract holes from copper areas
                """
                ...
                """Output file format, options: json, report [nargs=0..1] [default: "report"]"""
                units: str | None = None
                """Report units; valid options: in, mm [nargs=0..1] [default: "mm"]"""
                # Flags
                help: bool = False
                """Shows help message and exits"""
                exclude_footprints_without_pads: bool = False
                """Exclude footprints without pads"""
                subtract_holes_from_board: bool = False
                """Subtract holes from the board area"""
                subtract_holes_from_copper: bool = False
        ...
        class _import:
            ...
            Args:
                ...
                report_format: Import report format: none, json, text (default: none) [nargs=0..1] [default: "none"]
                report_file: File path for import report (default: stdout) [nargs=0..1] [default: ""]
                help: Shows help message and exits
            """
            ...
            """Output file [nargs=0..1] [default: ""]"""
            format: str | None = None
            """Input format hint: auto, pads, altium, eagle, cadstar, fabmaster, pcad, solidworks (default: auto) [nargs=0..1] [default: "auto"]"""
            report_format: str | None = None
            """Import report format: none, json, text (default: none) [nargs=0..1] [default: "none"]"""
            report_file: str | None = None
            """File path for import report (default: stdout) [nargs=0..1] [default: ""]"""
            # Flags
            help: bool = False
            """Shows help message and exits"""
        ...
        class render:
            ...
            Args:
                ...
                use_board_stackup_colors: Colors defined in board stackup override those in preset [nargs=0..1] [default: true]
            ...
            """Render quality. Options: basic, high, user, job_settings [nargs=0..1] [default: "basic"]"""
            preset: str | None = None
            """Appearance preset. Options: follow_pcb_editor, follow_plot_settings, or user-defined preset name [nargs=0..1] [default: "follow_plot_settings"]"""
            use_board_stackup_colors: str | None = None
            """Colors defined in board stackup override those in preset [nargs=0..1] [default: true]"""
            zoom: str | None = None
            ...
            """Shows help message and exits"""
            floor: bool = False
            """Enables floor, shadows and post-processing, even if disabled in quality setting"""
    ...
    class sch:
        ...
        class export:
            ...
            class bom:
                ...
                Args:
                    ...
                    sort_asc: Sort ascending (true) or descending (false). [nargs=0..1] [default: true]
                    ...
                    include_excluded_from_bom: Deprecated.  Has no effect.
                ...
                """An ordered list of fields to export. Generated fields such as QUANTITY, ITEM_NUMBER, DNP, EXCLUDE_FROM_BOM, EXCLUDE_FROM_BOARD, and EXCLUDE_FROM_SIM can be specified with or without ${} delimiters. [nargs=0..1] [default: "Reference,Value,Footprint,QUANTITY,DNP"]"""
                ...
                """Sort ascending (true) or descending (false). [nargs=0..1] [default: true]"""
            ...
            class dxf:
                ...
                """Default font name [nargs=0..1] [default: ""]"""
                pages: str | None = None
            ...
            class hpgl:
                ...
                Args:
                    ...
                    default_font: Default font name [nargs=0..1] [default: ""]
                    pages: List of page numbers separated by comma to print, blank or unspecified is equivalent to all pages [nargs=0..1] [default: ""]
                    pen_size: Deprecated.  Has no effect. [nargs=0..1] [default: 0.5]
                    origin: Deprecated.  Has no effect. [nargs=0..1] [default: 1]
                    help: Shows help message and exits
                    black_and_white: Black and white only
                    exclude_drawing_sheet: No drawing sheet
                    draw_hop_over: Draw hop over at wire crossings
                ...
                """Deprecated.  Has no effect. [nargs=0..1] [default: 0.5]"""
                origin: str | None = None
                """Deprecated.  Has no effect. [nargs=0..1] [default: 1]"""
                # Flags
                help: bool = False
                """Shows help message and exits"""
                black_and_white: bool = False
        ...
        class upgrade:
            ...
            """Shows help message and exits"""
            force: bool = False
            """Forces the schematic file to be resaved regardless of versioning"""
    ...
    class sym:
        ...
        class upgrade:
            ...
            Args:
                INPUT_FILE_OR_DIR: Input file or directory
                output: Output file or directory [nargs=0..1] [default: ""]
                help: Shows help message and exits
            ...
            # Arguments (Optional)
            output: str | None = None
            """Output file or directory [nargs=0..1] [default: ""]"""
            # Flags
            help: bool = False
            """Shows help message and exits"""
            force: bool = False
